...
public class controllerEvento {
	...
	String[] menu = {"1-Criar Evento","2-Alterar Evento","3-Excluir Evento"};
	...
	String comentarioOP = view.readLine("Digite o comentario do evento");	
	...
	case 3:
		...
		String idExluirOP = view.readLine("Digite o Id do Evento para excluir");
