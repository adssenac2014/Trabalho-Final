...
public class IssueDataLista {

	private CsvDataLista csvData;

	private String nomeArquivo;

	private ListaLigada<String[]> registrosIssuesString;

	

	public IssueDataLista() {
	...
	private ListaLigada<String[]> converterProjetoParaString(
		...
		registrosIssuesString = new ListaLigada<String[]>();
		...
		while (!projetoLista.vazia()) {
			...
			registrosIssuesString.adicionaNoFim(linha);
		}

		return registrosIssuesString;
	}
